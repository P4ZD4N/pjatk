...
read -p "Add toString method? (y/n): " ADD_TO_STRING

if [[ $ADD_TO_STRING = 'Y' || $ADD_TO_STRING = 'y' ]] ; then
  
  echo "" >> "$PCKG_NAME/$CLASS_NAME.java"
  echo "	@Override" >> "$PCKG_NAME/$CLASS_NAME.java"
  echo "	public String toString() {" >> "$PCKG_NAME/$CLASS_NAME.java"
  echo "		return \"$CLASS_NAME{\" +" >> "$PCKG_NAME/$CLASS_NAME.java"
  echo "		$FIELDS_AND_VALUES" >> "$PCKG_NAME/$CLASS_NAME.java"
  echo "		\"}\";" >> "$PCKG_NAME/$CLASS_NAME.java"
  echo "	}" >> "$PCKG_NAME/$CLASS_NAME.java"
